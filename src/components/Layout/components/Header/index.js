                ...
                <Link to={config.routes.home}>
                    <div className={cx('logo')}>
                        <svg
                            ...
                            alt="TikTok"
                        >
                            <g clipPath fill="#25F4EE">
                                <path d="M9.875 16.842v-1.119A8.836 8.836 0 0 0 8.7 15.64c-4.797-.006-8.7 3.9-8.7 8.707a8.706 8.706 0 0 0 3.718 7.135A8.675 8.675 0 0 1 1.38 25.55c0-4.737 3.794-8.598 8.495-8.707Z"></path>
                                <path
                                    fill="#25F4EE"
                    ...
                    <Menu items={currentUser ? userMenu : MENU_ITEMS} onChange={handleMenuChange}>
                        {currentUser ? (
                            <Image
                                ...
                                src="https://p16-sign-sg.tiktokcdn.com/aweme/100x100/tos-alisg-avt-0068/d2c208cb43862856b92f7f6f3ad0ed2e.jpeg?lk3s=a5d48078&x-expires=1708758000&x-signature=GZXvXMJZPog8UNhD7ecL3fDfndQ%3D"
                                alt="Nguyen Van A"
                            />
                        ) : (
